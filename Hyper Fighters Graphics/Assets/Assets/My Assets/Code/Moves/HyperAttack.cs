...
public class HyperAttack : BaseMove
{
    void Start()
    {
        base.Initialize();
    ...
    {
        if (m_me.CheckCurrentAnimation(E_ANIMATIONS.HYPER))
        {
